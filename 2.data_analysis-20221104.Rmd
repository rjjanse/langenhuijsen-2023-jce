...
# write_xlsx(dat.sq.check, path = "irv_sq.xlsx")
# 
# # Domain level
...
# 
# # Write data to Excel to start checking
# write_xlsx(dat.dom.check, path = "irv_dom.xlsx")

## SQ ----
# Load checked duplicates
#dat.irv.sq <- read_excel("Duplicates.xlsx", sheet = "SQ", skip = 3)
dat.irv.sq <- read_excel("Duplicates.xlsx", sheet = "SQ", skip = 3)
...
# Save figure
ggsave("irv_sq.png", plot = p, path = "", width = 6, height = 6, dpi = 600)
...
# 
# # Save data
# save(dat.kap.sa.sq, file = "dat_kap_sa_sq.Rdata")

# Load data
load("Cdat_kap_sa_sq.Rdata")
...
# 
# # Save figure
# ggsave("sa_irv_sq.png", plot = p, path = "", width = 20, height = 10, dpi = 600)
...
#dat.irv.dom <- read_excel("", sheet = "Domain", skip = 3)
dat.irv.dom <- read_excel("", sheet = "Domain", skip = 3)
...
# Save figure
ggsave("irv_dom.png", plot = p, path = "", width = 6, height = 6, dpi = 600)
...
# 
# # Save data
# save(dat.kap.sa.dom, file = "dat_kap_sa_dom.Rdata")

# Load data
load("dat_kap_sa_dom.Rdata")
...
# 
# # Save figure
# ggsave("sa_irv_dom.png", plot = p, path = "", width = 16, height = 10, dpi = 600)
...
# Load checked domain duplicates
dat.irv.dom <- read_excel("Duplicates.xlsx", sheet = "Domain", skip = 3)
...
write_xlsx(tab.dom, path = "tabs1.xlsx")
